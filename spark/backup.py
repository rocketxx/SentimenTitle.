...
####################################################
# Tutta questa parte è opzionale.
#
# Elastic è in grado di crearsi il suo index
# solo in base ai dati che riceve.
#
# Se qualche per qualche mapping non ti piace il tipo
# automatico, allora lo puoi forzare con quello che
# facevi prima.
#
# In quel caso, devi riaggiugere qualche import che
# per adesso ho tolto perchè non servono.
# Puoi sempre riguardare la versione vecchia per 
# sapere cosa aggiungere
###################################################

#con filedata ogni parola puo essere usata come indice
# es_mapping = {
#     "mappings": {
#         "properties": {
#             "@timestamp": {
...
if __name__ == "__main__":
    ...
    # Show some data (OPTIONAL, can be removed for performance)
    print("*****************Pipeline fit *****************************")
    print(pipelineFit)
    print("*****************Accuracy*****************************")
